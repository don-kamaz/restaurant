...
<body class="body-fixed">
                            ...
                            <div class="col-xl-10 col-lg-10 d-none d-lg-block">
                                <div class="menu-main d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="header-right-btn f-right d-none d-lg-block ml-20">
                                        <button type="button" class="border-btn header-btn">Order Online</button>
                                    </div>
                                </div>
                            </div>   
                            <!-- Mobile Menu -->
                            <div class="col-3 ml-auto d-lg-none">
                                <div class="mobile_menu d-flex d-lg-none justify-content-end">
                                    <button type="button" class="slicknav_btn slicknav_collapsed slicknav_menutxt ml-auto">MENU</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                ...
                <div class="single-slider slider-height d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-9 col-lg-9 col-md-9 swiper-container">
                                ...
                                <div class="hero__caption swiper-slide">
                                    ...
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="#" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Reservation</a>
                                    </div>
                                </div>
                                <div class="hero__caption swiper-slide">
                                    <span data-animation="fadeInLeft" data-delay=".2s">Discover Your Teste</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">God save the Queen</h1>
                                    <p data-animation="fadeInLeft" data-delay=".6s">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat is aute irure.</p>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="#" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Reservation</a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <!-- about-img -->
                        <div id="scene">
                            <div class="about-img layer" data-depth="1">
                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                          
                                <div class="nav nav-tabs" id="nav-tab">
                                    <button type="button" class="nav-item nav-link" id="nav-home-tab">Special</button>
                                    <button type="button" class="nav-item nav-link" id="nav-profile-tab">Lunch</button>
                                    <button type="button" class="nav-item nav-link" id="nav-contact-tab">Brakefirst</button>
                                    <button type="button" class="nav-item nav-link" id="nav-dinner-tab">Dinner</button>
                                </div>
                            </nav>
                            <!--End Nav Button  -->
                        </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row no-gutters">
                            <div class="col-lg-5 col-md-6 col-sm-6 gallery-box_wrapper">
                                <div class="gallery-box">
                                    <div class="single-gallery">
                                        ...
                                        <div class="g-caption">
                                            ...
                                            <button type="button" class="btn order-btn">Order Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 gallery-box_wrapper">
                                <div class="gallery-box">
                                    <div class="single-gallery">
                            ...
                            <div class="col-lg-3 col-md-12 gallery-box_wrapper">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6 gallery-box_wrapper">
                                        <div class="gallery-box">
                                            <div class="single-gallery">
        ...
        <div class="booking-area section-bg pt-120 pb-130" style="background-image: url('assets/img/gallery/section_bg04.png')">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <form action="mail.php" id="booking" class="form-book booking js-form">
                            <input type="text" name="name" class="form-book__input" placeholder="Name" required>
                            <input type="text" name="email" class="form-book__input" placeholder="Email" required>
                            <input type="tel" name="phone" class="form-book__input" placeholder="Phone" required>
                            <button type="submit" class="btn select-btn" data-submit>Book Now</button>
                            <span id="message-for-user">Thank you. We will call you as soon as possible.</span>
                        </form>
                    </div>
                </div>
            </div>
  ...
  <!--noindex-->
  <a href="https://colorlib.com" rel="nofollow noopener noreferrer" target="_blank">Colorlib</a>
  <!--noindex-->
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            ...
                            <div class="footer-social f-right">
                                <span>Follow Us</span>
                                <!--noindex-->
                                <a href="#" rel="nofollow noopener noreferrer" target="_blank"><i class="fab fa-twitter"></i></a>
                                <!--noindex-->
                                <!--noindex-->
                                <a href="https://www.facebook.com/sai4ull" rel="nofollow noopener noreferrer" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                <!--noindex-->
                                <!--noindex-->
                                <a href="#" rel="nofollow noopener noreferrer" target="_blank"><i class="fas fa-globe"></i></a>
                                <!--noindex-->
                                <!--noindex-->
                                <a href="#" rel="nofollow noopener noreferrer" target="_blank"><i class="fab fa-instagram"></i></a>
                                <!--noindex-->
                            </div>
                        </div>
                    </div>
    ...
    <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="modals__wrapper">
                            <div id="modals__overlay" class="modals__overlay"></div>
                            <form action="mail.php" id="modals__window" class="form-book modals__window js-form">
                                <input type="text" name="name" class="form-book__input" placeholder="Name" required>
                                <input type="text" name="email" class="form-book__input" placeholder="Email" required>
                                <input type="tel" name="phone" class="form-book__input" placeholder="Phone" required>
                                <button type="submit" class="btn select-btn" data-submit>Book Now</button>
